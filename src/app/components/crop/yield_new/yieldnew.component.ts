...
@Component({
  selector: 'app-yieldnew',
  templateUrl: './yieldnew.component.html',
  styleUrls: ['./yieldnew.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class YieldNewComponent implements OnInit {
  public refdata: any = {};
  public years=[];
  public edits=[];
  public rowData=[];
  ...
  addrow() {
    ...
    const dialogRef = this.dialog.open(YieldNewDialogComponent, {
      width: '250px',
...
@Component({
  ...
  templateUrl: 'yieldnew.dialog.component.html',
})
export class YieldNewDialogComponent {

  constructor(
    public dialogRef: MatDialogRef<YieldNewDialogComponent>,
