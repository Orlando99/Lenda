...
export class OverallCalculationServiceService {
  ...
  balancesheet_calc(loanObject: loan_model) {
    ...
    loanMaster.FC_Current_Adjvalue = loanMaster.Current_Assets * loanMaster.Current_Assets_Disc_Percent / 100;
    
    loanMaster.FC_Inter_Adjvalue = loanMaster.Inter_Assets * loanMaster.Inter_Assets_Disc_Percent / 100;
    
    loanMaster.FC_Fixed_Adjvalue = loanMaster.Fixed_Assets * loanMaster.Fixed_Assets_Disc_Percent / 100;
